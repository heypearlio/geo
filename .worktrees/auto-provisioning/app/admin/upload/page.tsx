...
const OFFERS = [
  { value: "v2",        label: "V2 — Done-for-you listing system",   prefix: "v2-",  note: "Replies appear in /admin/v2-leads" },
  { value: "geo",       label: "GEO — AI Visibility Score",          prefix: "geo-", note: "Replies appear in /admin/leads" },
  { value: "affiliate", label: "Affiliate — Recruit resellers",      prefix: "aff-", note: "Replies tagged 'god' in affiliate leads" },
];
  ...
  return (
    <div style={{ background: S.bg, minHeight: "100vh", fontFamily: "system-ui, sans-serif" }}>
      <div style={{ maxWidth: 720, margin: "0 auto", padding: "40px 24px" }}>
        ...
        <h1 style={{ color: S.text, fontSize: 22, fontWeight: 800, marginBottom: 4 }}>Upload Cold List</h1>
        <p style={{ color: S.muted, fontSize: 13, marginBottom: 32 }}>
          Leads go directly to Instantly. They appear in the appropriate /leads view only when they reply.
          Name campaigns with the right prefix: <code>v2-</code>, <code>geo-</code>, <code>aff-</code>
        </p>
