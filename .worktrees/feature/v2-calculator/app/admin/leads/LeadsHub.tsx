...
const SRC_LABEL: Record<string, string> = {
  ...
  calendly_affiliate: "Affiliate",
};
const SYSTEM_SOURCES = new Set(["audit", "claim", "calendly_geo", "import", "unknown", "affiliate_application", "calendly_affiliate"]);
        ...
        {mode === "csv" && (
          <div>
            ...
            <div style={{ color: C.faint, fontSize: 12, marginBottom: 12 }}>
              Paste CSV or upload a file. Required column: <code>email</code>. Optional: <code>first_name</code>
            </div>
            ...
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 6 }}>
              <span style={{ color: C.muted, fontSize: 11, textTransform: "uppercase" as const, letterSpacing: "0.06em" }}>CSV Data</span>
              <label style={{ background: C.bg, border: `1px solid ${C.border}`, borderRadius: 6, padding: "4px 10px", fontSize: 12, color: C.navy, cursor: "pointer", fontWeight: 600 }}>
                Choose File
